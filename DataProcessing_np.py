...
if flag == "Y":
   ...
   Functions_np.DrawChannelSignalsPlot(dataStoreDir, "Original Experimental Data.png", time, 
...
timeModified, reflectWave, transWave = Functions_np.FindingSections(dataStoreDir, time, inputChannel, transChannel)
...
trueStress, trueStrainRate, trueStrain = \
    Functions_np.EngineeringToTrue(engStress, engStrain, engStrainRate)

Functions_np.DrawStressStrainPlot(dataStoreDir, engStress, engStrain)

kEng, b = Functions_np.FittingStrainRate(dataStoreDir, timeModified, engStrain, False)
kTrue, b = Functions_np.FittingStrainRate(dataStoreDir, timeModified, trueStrain, True)

print("True Strain rate is: ", kTrue)

Functions_np.WritingDataToExcel(dataStoreDir, timeModified, engStress, \
engStrain, engStrainRate, trueStress, trueStrain, trueStrainRate, kTrue, kEng)
