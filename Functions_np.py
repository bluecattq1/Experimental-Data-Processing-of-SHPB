...
def WritingDataToExcel(dataStoreDir, time, engStress, engStrain, engStrainRate, \
    ...
    WritingExcelColumn(ws, "Engineering Strain Rate/s^-1", 1, engStrainRate)
    WritingExcelColumn(ws, "Engineering Strain", 2, engStrain)
    WritingExcelColumn(ws, "Engineering Stress/MPa", 3, engStress)
    ...
    ws.write(4, 8, "Engineering Strain Rate/s^-1: ")
    ws.write(5, 8, kEng)
    ws.write(6, 8, "True Strain Rate/s^-1: ")
    ws.write(7, 8, kTrue)
